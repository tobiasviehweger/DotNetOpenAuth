...
";
        ...
        public IDirectedProtocolMessage ReadFromRequest(MessageReceivingEndpoint recipient,WebHeaderCollection headers)
        {
            IDirectedProtocolMessage requestMessage = this.ReadFromRequestCore(recipient);
            if (requestMessage != null)
            {
                ...
                if (directRequest != null)
                {
                    ...
                    {
                        directRequest.Headers[header] = headers[header];
                    }
                }
        ...
        /// <returns>The deserialized message, if one is found.  Null otherwise.</returns>
        protected virtual IDirectedProtocolMessage ReadFromRequestCore(MessageReceivingEndpoint recipient)
        {
