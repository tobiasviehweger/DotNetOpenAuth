...
namespace DotNetOpenAuth.OAuth2.ChannelElements {
    ...
    internal class OAuth2ClientChannel : OAuth2ChannelBase, IOAuth2ChannelWithClient {
        ...
        /// </returns>
        /// 
        protected override IDirectedProtocolMessage ReadFromRequestCore(MessageReceivingEndpoint recp)
        {
            ...
            if (queryParam != null && queryParam.Count > 0)
            {
                ...
                {
                    fields.Add(key, queryParam[key]);
                }
            }

            return (IDirectedProtocolMessage)this.Receive(fields, recp);
        }
